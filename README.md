...
The script can be downloaded and executed dynamically using the following command:
    ...
    bash <(curl -s -L https://raw.github.com/blackducksoftware/detect_rescan/dev/detect_rescan.sh) ARGUMENTS DETECT_OPTIONS
